...
export const practiceConfigs: Record<string, PracticeConfig> = {
  'dr-sw-clinics': {
    ...
    agentId: 'agent_1701k275311qem2v9rt4gnqtymd4', // Dr SW Clinics - Dr Sherif Wakil (WORKING)
    ...
    services: [
      {name: 'Dermal Fillers', description: 'Advanced dermal filler treatments'},
      {name: 'Anti-Wrinkle Injections', description: 'Botox and anti-aging treatments'},
      {name: 'Lip Enhancement', description: 'Lip filler and shaping treatments'},
      {name: 'Skin Rejuvenation', description: 'Non-surgical skin treatments'},
      {name: 'Consultation', description: 'Initial consultation and assessment'}
    ],
    
    branding: {
      primaryColor: '#e91e63',
      tagline: 'Non-Surgical Beauty Excellence',
      focus: 'Advanced cosmetic treatments'
    }
  },
  'advanced-spine-care': {
...
export function getCurrentPractice(): PracticeConfig {
  ...
  if (typeof window === 'undefined') {
    ...
    const practiceId = process.env.PRACTICE_ID || process.env.NEXT_PUBLIC_PRACTICE_ID || 'dr-sw-clinics';
